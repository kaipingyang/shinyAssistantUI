...
|    11 | A2UI over AG-UI          | **Future plan**       | Evaluate an optional A2UI surface-operation converter and action bridge while retaining the Shiny transport and current Data/Generative UI paths. No current A2UI or AG-UI support is claimed. |
