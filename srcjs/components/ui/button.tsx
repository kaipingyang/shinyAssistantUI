...
>(function Button(
  ...
  // React 18 下必须用 forwardRef 才能收到 ref;否则 asChild 场景(如 radix
  // DropdownMenu.Trigger asChild -> Button)ref 被丢弃,radix 测不到锚点,弹层
  // 定位到 (0,0) 再被 translate 推出屏幕 —— 侧栏 ... 菜单"点了没反应"的真因。
