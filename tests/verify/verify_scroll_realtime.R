...
PROJ<-"/usrfiles/shared-projects/users/kaiping_yang/shinyAssistantUI"; PORT<-9897L
...
cat(sprintf("[%s] viewport tracks bottom in real-time (median<=60 & <200px-behind<=12)\n", if(med<=60 && behind<=12)"PASS" else "FAIL"))
